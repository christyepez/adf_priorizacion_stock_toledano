...
# COMMAND ----------
# MAGIC %md
# MAGIC # Extraccion Bronze - Filtrar Propietario Sharepoint
# MAGIC
...
dbutils.widgets.text("propietario_fuente", "DatosPortalDeInformacion")
dbutils.widgets.text("modo_control", "get_control_cargas")

# Placeholder administrado por bundle para filtrar PropietarioFuente SharePoint.
