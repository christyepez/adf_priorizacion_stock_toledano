...
Se implementa `01_nb_get_control_cargas.py` y `get_control_cargas.py` para reemplazar los Lookup ADF `GetControlCargas` y `LK_ControlCargas`.
...
- `01_nb_bronze_to_silver_m_ofertas_doc_ventas.py`
- `02_nb_bronze_to_silver_cv_lo_pedido.py`
- `01_nb_bronze_to_silver_grupos_priorizacion.py`
- `02_nb_bronze_to_silver_priorizaciones_previas.py`
...
- `notebooks/04_modelo/02_nb_creacion_indice_priorizacion.py`
...
- `notebooks/06_quality/01_nb_quality_checks.py`
- `notebooks/06_quality/02_nb_reconciliation_adf.py`
- `notebooks/05_publicacion/01_nb_publicar_resultados_sql.py`
...
- `notebooks/07_audit/01_nb_audit_start.py`
- `notebooks/07_audit/03_nb_audit_finish.py`
- `notebooks/07_audit/02_nb_notify.py`
...
3. Comparar conteos y resultados mediante `02_nb_reconciliation_adf.py`.
